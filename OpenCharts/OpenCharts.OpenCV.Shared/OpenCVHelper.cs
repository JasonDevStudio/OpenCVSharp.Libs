...
public class OpenCVHelper
{
    ...
    public void DrawText(InputOutputArray src, string text, Point org, double fontScale, Scalar color, HersheyFonts fontFace = HersheyFonts.HersheySimplex, int thickness = 1, LineTypes lineType = LineTypes.AntiAlias, bool bottomLeftOrigin = false) => Cv2.PutText(src, text, org, HersheyFonts.HersheySimplex, fontScale, color, thickness, lineType, bottomLeftOrigin);
